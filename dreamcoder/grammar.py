...
class Grammar(object):
    ...
    def sample(self, request, maximumDepth=6, maxAttempts=None, minimumDepth=3):
        attempts = 0
                                            ...
                                            for a3 in expressions_of_size(at3, c3):
                                                ...
                                                for a4 in expressions_of_size(at3, size-cost-c1-c2-c3):
                                                    ...
                                                    new.append(Application(Application(
                                                        Application(Application(k, a1), a2), a3), a4))
                                                ...
                                                for c4 in range(size-cost-c1-c2-c3):
                                                    for a4 in expressions_of_size(at3, c4):
                                                        ...
                                                        for a5 in expressions_of_size(at3, size-cost-c1-c2-c3-c4):
                                                            ...
                                                            new.append(Application(Application(Application(
                                                                Application(Application(k, a1), a2), a3), a4), a5))
                    else:
