...
class RolloutStorage(object):
    ...
    def save(self, path):
        to_save = np.array([{
            ...
            'action_log_probs': self.action_log_probs.numpy(),
            'action_log_dist': self.action_log_dist.numpy(),
            'value_preds': self.value_preds.numpy(),
            'masks': self.masks.numpy(),
            'bad_masks': self.bad_masks.numpy(),
            'cliffhanger_masks': self.cliffhanger_masks.numpy(),
            'level_seeds': self.level_seeds.numpy()
        }])
